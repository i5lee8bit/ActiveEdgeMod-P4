...
curl -o blueline-%BUILDVAR%-SystemUIGoogle.apk https://dumps.tadiphone.dev/dumps/google/blueline/-/raw/blueline-user-11-RQ2A.210405.006-7214111-release-keys/system_ext/priv-app/SystemUIGoogle/SystemUIGoogle.apk
ECHO.
...
curl -o crosshatch-%BUILDVAR%-SystemUIGoogle.apk https://dumps.tadiphone.dev/dumps/google/crosshatch/-/raw/crosshatch-user-11-RQ2A.210405.006-7214111-release-keys/system_ext/priv-app/SystemUIGoogle/SystemUIGoogle.apk
ECHO.
